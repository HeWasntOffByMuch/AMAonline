...
module.exports = function Player(options) {
    ...
    var belongsTo = options.belongs_to;
    var timePlayed = options.time_played || 0; //only saves if u log out properly.
    ...
    var skillTree = new SkillTree(options.skill_tree);
  var moveTime = false;
  var moving = false;
    var nextMove = false;
    ...
    var healthCur = options.health_cur || this._.healthMax;

    var manaCur = options.mana_cur || this._.manaMax;

    var equipment = options._equipment;
